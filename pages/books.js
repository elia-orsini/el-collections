...
const IndexPage = ({ books }) => {
  ...
  return (
        <div>
          ...
          <div className="my-auto mt-10">
            <div className="mx-auto my-auto w-full text-center">
              <p className="text-7xl font-black">{booksADay}</p>
              <p className="text-base -mt-3">days to read a book</p>
            </div>

            <div className="mx-auto my-auto sm:w-3/5 lg:w-2/5 text-center pt-20 grid grid-cols-2">
              <div>
        ...
        <p className="absolute w-full bottom-0 text-center text-xs mb-10 mt-28">
          made by el © 2022<br />
